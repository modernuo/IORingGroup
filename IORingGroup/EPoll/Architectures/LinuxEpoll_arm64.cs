...
/// <summary>
/// Linux ARM64 syscall bindings for epoll and sockets.
/// </summary>
internal sealed partial class LinuxEpoll_arm64 : ILinuxEpollArch
{
    public static readonly LinuxEpoll_arm64 Instance = new();

    private LinuxEpoll_arm64() { }

    // =============================================================================
    // Socket constants (same as Linux x64)
    // =============================================================================
    ...
    // epoll_event size for ARM64 (sequential: 4 bytes events + 4 padding + 8 bytes data = 16 bytes)
    public const int EPOLL_EVENT_SIZE = 16;
